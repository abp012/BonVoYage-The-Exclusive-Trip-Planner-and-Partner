// Email sending utility function that works directly with Resend API
...
const formatTravelWith = (travelWith?: string) => {
  if (!travelWith) return 'Travelers';
...
function generateEmailTemplate(tripData: TripData, tripDetails?: TripDetails, userName?: string): string {
  return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
      ...
      <div class="container">
        ...
        <div class="content">
          ...
          ${tripDetails ? `
            ...
            ${tripDetails.detailedItinerary?.length ? `
              <div class="section">
            ...
            ${tripDetails.topActivities?.length ? `
              <div class="section">
            ...
            ${tripDetails.localCuisine?.length ? `
              <div class="section">
            ...
            ${tripDetails.packingList?.length ? `
              <div class="section">
                <h2>🧳 Packing List</h2>
          ...
          <div class="section">
            ...
            <p>We're excited for your upcoming trip to ${tripData.destination}! Make sure to check the weather before you leave and pack accordingly.</p>
  ...
  try {
    const response = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        ...
        to: [to],
        subject: `Your Trip to ${tripData.destination} is Ready! ✈️`,
        html: generateEmailTemplate(tripData, tripDetails, userName),
      }),
    });
